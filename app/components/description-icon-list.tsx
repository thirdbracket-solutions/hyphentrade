    ...
    <section className="bg-slate-50 dark:bg-gray-800 ">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
        <div className="mb-8 lg:mb-16 ">
          ...
          <p className="mb-4 text-lg font-normal text-gray-500 dark:text-gray-400 leading-7 text-justify">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
          ...
          <div className="space-y-2.5">
            ...
            <p className="text-gray-500 dark:text-gray-400 leading-6 text-justify">
              ...
              real-time data analytics – this supports our marketing
              distinctively – our ability in data-driven marketing remains
              currently unmatched.
            </p>
          </div>
          <div className="space-y-2.5">
