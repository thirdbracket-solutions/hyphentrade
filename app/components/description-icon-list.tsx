        ...
        <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
          <div>
            ...
            <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 tracking-tight leading-tight">
              Working relationship with the key stakeholders in Bangladesh in
              the GTG space
            </h3>
          ...
          <div>
            ...
            <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 tracking-tight leading-tight">
              Direct access to all major importers in Bangladesh
            </h3>
            <p className="text-gray-500 dark:text-gray-400 leading-6">
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 leading-6">
              Deep access to all major bank’s decision makers in international
              trade – we are able to offer payment risk management which is a
