        ...
        <div className="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Our specialized, local team offers multiple layers of advantages
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              ...
              Bangladesh. Commodity sellers are not able to offer the full
              relationship management model in Bangladesh – a proposition that
              offers an array of advantages.
            </p>
          </div>
          <div>
            <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900 lg:h-12 lg:w-12">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Hyphen Trade works with a single seller for a specific product
              category. We only work on an exclusive basis.
            </p>
          </div>
          <div>
            <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900 lg:h-12 lg:w-12">
